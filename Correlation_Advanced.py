...
corr_gesamt = np.zeros((120,2702))
mean_gesamt = np.zeros((120,2702))
std_gesamt = np.zeros((120,2702))
k = 0
while k < 120:
    corr_gesamt[k][0] = k+1
    mean_gesamt[k][0] = k + 1
...
#koeffizient_corr = np.zeros((2701,5))
#koeffizient_mean = np.zeros((2701, 5))
#koeffizient_std = np.zeros((2701, 5))
...
workbook.save('datasets/Ergebnisse_alle.xlsx')